...
(function make_xlsx(XLSX) {
    ...
    var make_offcrypto = function (O, _crypto) {
        ...
        if (typeof _crypto !== 'undefined') crypto = _crypto;
            ...
            try { crypto = require('cry' + 'pto'); } catch (e) { crypto = null; }
        }
    ...
    var FtTab = {
        ...
        0x13: parsenoop,
        /* FtLbsData */
        0x12: function (blob, length) { blob.l += 12; },
        /* FtCblsData */
        0x11: function (blob, length) { blob.l += 8; },
        /* FtRboData */
        0x10: parsenoop,
        /* FtEdoData */
        0x0F: parsenoop,
        ...
        0x0D: parse_FtNts,
        /* FtNts */
        0x0C: function (blob, length) { blob.l += 24; },
        /* FtSbs */
        0x0B: function (blob, length) { blob.l += 10; },
        /* FtRbo */
        0x0A: function (blob, length) { blob.l += 16; },
        /* FtCbls */
        0x09: parsenoop,
        /* FtPictFmla */
        0x08: function (blob, length) { blob.l += 6; },
        /* FtPioGrbit */
        0x07: parse_FtCf,
        /* FtCf */
        0x06: function (blob, length) { blob.l += 6; },
        /* FtGmo */
        0x04: parsenoop,
        /* FtMacro */
            ...
            for (var marr = sdata.split(rowregex), mt = 0, marrlen = marr.length; mt != marrlen; ++mt) {
                ...
                for (ri = typeof tag.r === 'undefined' ? 0 : 1; ri != cells.length; ++ri) {
                    ...
                    if (do_format && tag.s !== undefined) {
                        ...
                        if (cf != null) {
                            if (cf.numFmtId != null) fmtid = checkdateType(cf.numFmtId);
    ...
    function checkdateType(param) {
        if (param == 164 || param == 168 || param == 166 || param == 169) {
            return 14
        } else {
            return param
        }
