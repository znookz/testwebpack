window.FontAwesomeKitConfig = { "asyncLoading": { "enabled": false }, "autoA11y": { "enabled": true }, "baseUrl": "", "detectConflictsUntil": null, "iconUploads": {}, "license": "free", "method": "css", "minify": { "enabled": true }, "token": "586eb398d0", "v4FontFaceShim": { "enabled": true }, "v4shim": { "enabled": true }, "version": "5.15.1" };
! function(t) { "function" == typeof define && define.amd ? define(t) : t() }((function() {
            ...
            o = document.createTextNode(function(t, e, n) {
                ...
                return [
                    ...
                    [/(url\("?)\.\.\/webfonts/g, function(t, o) {
                        return "".concat(o).concat(e, "./fontawesome/v").concat(n, "/webfonts")
                    }],
    ...
    function F(t, e) {
        e.autoA11y = t.autoA11y.enabled, "pro" === t.license && (e.autoFetchSvg = !0, e.fetchSvgFrom = t.baseUrl + "/fontawesome/" + ("latest" === t.version ? "latest" : "v".concat(t.version)) + "/svgs", e.fetchUploadedSvgFrom = t.uploadsUrl);
        var n = [];
    ...
    try {
        if (window.FontAwesomeKitConfig) {
            ...
            })).catch((function(t) { console.error("".concat("Font Awesome 5 Free:", " ").concat(t)) }))
        }
    } catch (t) { console.error("".concat("Font Awesome 5 Free:", " ").concat(t)) }
}));